...
namespace AsistenteAyuntamiento.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260904162245_AddRagQuestionArena")]
    partial class AddRagQuestionArena
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AsistenteAyuntamiento.Domain.Features.Arena.ArenaBattle", b =>
                {
                    ...
                    b.Property<string>("ClarityReason")
                        .HasMaxLength(20)
                    ...
                    b.Property<string>("PrecisionReason")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");
